...
// Preload images
const imageSources = [
  "images/pomodoro-still.jpg",
  "images/pomodoro-running.gif",
  "images/short-still.jpg",
  "images/short-running.gif",
  "images/long-still.jpg",
  "images/long-running.gif",
  "",
];
...
function preloadImage(timerType) {
  ...
  if (timerType === "pomodoro") {
    tempImage.src = "images/pomodoro-running.gif"; // Image for running
  } else if (timerType === "shortBreak") {
    tempImage.src = "images/short-running.gif"; // Image for running
  } else if (timerType === "longBreak") {
    tempImage.src = "images/long-running.gif"; // Image for running
  ...
  timerInterval = setInterval(function () {
    if (!isPaused) {
      ...
      if (minutes === 0 && seconds === 0) {
        ...
        setImage("images/pomodoro-still.jpg");
...
function getImageSource(timerType) {
  if (timerType === "pomodoro") {
    return "images/pomodoro-running.gif"; // Image for running
  } else if (timerType === "shortBreak") {
    return "images/short-running.gif"; // Image for running
  } else if (timerType === "longBreak") {
    return "images/long-running.gif"; // Image for running
  } else if (timerType === "testBreak") {
    return "images/pomodoro-running.gif"; // Image for running
  }

  // Default to pomodoro-running.gif if no match
  return "images/pomodoro-running.gif";
}
...
function getPausedImageSource(timerType) {
  ...
  if (timerType === "pomodoro") {
    return "images/pomodoro-still.jpg"; // Image when Pomodoro is paused
  } else if (timerType === "longBreak") {
    return "images/long-still.jpg";
  } else if (timerType === "shortBreak") {
    return "images/short-still.jpg";
  } else {
    return "images/pomodoro-running.gif"; // Fix the image name
  }
}
...
function stopTimer() {
  ...
  setImage("images/pomodoro-running.gif");
...
document
  .querySelector(".btn-info.longBreak")
